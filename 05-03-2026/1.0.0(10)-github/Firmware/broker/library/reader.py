# -*- coding: utf-8 -*-
__version__ = "1.0.0(10) - per-tag RSSI + per-antenna breakdown dumped to rssi.json every scan cycle"
...
#        2) Also captured the full antenna LIST (ant_list_now), not just
#           the count, where "antenna_count_now" used to be computed -
#           needed for rssi.json's "antennas_configured" metadata field.
#           Purely additive, does not change any existing behavior.
#
#      Version                    : 1.0.0(9) 
...
# NEW in 1.0.0(10): per-tag RSSI/antenna diagnostic dump - see
...
# =====================================================
#  RSSI/ANTENNA DIAGNOSTIC DUMP - NEW in 1.0.0(10)
#
...
def run_async_scan(baud, stop_event=None):
    ...
    epc_antenna_rssi = {}      # NEW in 1.0.0(10): {epc: {ant: best_rssi_on_that_antenna}} -
            ...
            while True:
                ...
                for tag in tags:
                    ...
                    if tag["RSSI"] is not None:
                        ...
                        # NEW in 1.0.0(10): same idea, but broken down PER
    ...
    # NEW in 1.0.0(10): dump per-tag RSSI + per-antenna breakdown for this
